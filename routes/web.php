...
use App\Http\Controllers\{CertificateController, ContractFeeController, CourseController, QuoteController, ReportController
                        , DocumentUploadController, HomeController, LeadNoteController, ContractStatusController
                        , LeadController, LeadOriginController, LeadStatusController, BankController, PersonInfController
                        , ContractController, CompanyController, UserController, TermController, LiquidationLogController
                        , EventMasterController, LiquidationController, ManagementNoteController, LiquidationModelController
                        , MyProfileController, LeadSubStatusController, TeacherController, EventMasterAdminController
                        , FinancialGraphController, CourseAreaController, SpreadsheetController, WhatsappTemplateController,ChatsController};
...
|--------------------------------------------------------------------------
*/  
Route::post('/sendmenssages', [ChatsController::class,'sendMenssages'])->name('send.menssage');
Route::post('/loadchat', [ChatsController::class,'loadChat'])->name('load.chat');
Route::get('/indexchat', [ChatsController::class,'index'])->name('chat.index');


Route::post('/readMessage' , function (Request $request){
