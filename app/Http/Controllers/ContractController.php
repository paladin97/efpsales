            ...
            if ($user->hasRole('superadmin')){
                $contract = Contract::from('contracts as c')
                        ...
                        ->select('c.*','crse.name as course_name'
                                ...
                                ,'pi.address as student_address','teacher.name as teacher_name','le.dt_assignment as dt_assignment'
                                ...
                                ,'com.name as company_name', 'com.address as company_address','com.url_facebook as url_facebook'
                                ,'com.url_instagram as url_instagram','com.url_business as url_business','com.url_website as url_website'
