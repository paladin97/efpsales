...
use App\Models\{User, Lead, Contract, PersonInf, Province, AutonomousCommunity, Menssage};
    ...
    public function index()
    {
        ...
        */
        $leadHome = Lead::from('leads as le')
            ...
            ->select(
                ...
                'crs.name as curso',
                'lu.name as lead_status',
                'lu.color_class as color_class'
            )
        ...
        $notesHome = Lead::from('lead_notes as ln')
            ...
            ->select(
                'ln.*',
                'u.name as agent_name',
                'u.last_name as agent_lastname',
                'crs.name as curso',
                'u.avatar as avatar',
                'le.student_first_name as student_name',
                'le.student_last_name as student_lastname',
        ...
        */
        ...
        foreach ($agentsTable as $key => $agent_id) {
            ...
            $querySP = DB::statement(
                DB::raw('CALL AgentInformationSales(?, ?, ?, ?, @out1, @out2, @out3, @out4, @out5, @out6, @out7)'),
