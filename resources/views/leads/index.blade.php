...
@section('content')
        ...
        <div class="card card-lightblue card-outline col-sm-3">
            ...
            <div class="card-body p-1 m-0">
                <ol>
                    ...
                    <li>Una vez haya escogido las opciones de filtrado, presione el botón <span
                            class="badge badge-pill bg-lightblue"><i class="fad fa-binoculars"></i> Filtrar</span>.</li>
                    <li>Para limpiar los filtros, presione el botón <span class="badge badge-pill bg-lightblue"><i
                                class="fad fa-eraser"></i> Limpiar Filtros</span> y luego el botón <span
                            class="badge badge-pill bg-lightblue"><i class="fad fa-binoculars"></i> Filtrar</span>.</li>
                    <li>Para refrescar la información, presione el botón <span class="badge badge-pill bg-lightblue"><i
                                class="fad fa-sync"></i> Refrescar Info</span>.</li>
                </ol>
            </div>
        </div>
        <div class="card card-lightblue card-outline col-sm-9" id="card-filter">
            <div class="card-header pl-3 pr-3 pt-2 pb-0">
                <h4><i class="fad fa-rotate-90 fa-sliders-h text-bold text-lightblue text-lg"></i> Establece los Filtros..
                </h4>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pull-right" id="filter_lead_id"
                                        value="{{ $lead_id }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row" style="margin: auto;">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="ranges" class="form-control form-control-sm pull-right"
                                        id="dt_reception_filter">
                                    <input type="hidden" class="form-control form-control-sm pull-right"
                                        id="dt_assignment_from">
                                    <input type="hidden" class="form-control form-control-sm pull-right"
                                        id="dt_assignment_to">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm select_list_filter" id="courses_list_filter"
                                    name="courses_list[]" multiple>
                                    @php
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select multiple class="form-control form-control-sm select_list_filter"
                                    id="provinces_list_filter" name="provinces_list_filter[]">
                        ...
                        @if (Auth::user()->hasRole('superadmin'))
                            <div class="col-sm-2">
                                <div class="form-group">
                                    ...
                                    <select multiple class="form-control form-control-sm select_list_filter"
                                        id="lead_origin_filter" name="lead_origin_filter[]">
                    ...
                    <div class="row mt-n2" style="margin: auto;">
                        @if (Auth::user()->hasRole('superadmin'))
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select multiple class="form-control form-control-sm select_list_filter"
                                        id="prev_agent_list_filter" name="prev_agent_list_filter[]">
                                        @foreach (App\Models\User::all() as $cData)
                                            @if ($cData->hasRole('comercial'))
                                                <option value="{{ $cData->id }}">{{ $cData->name }}</option>
                                            @endif
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm select_list_filter" id="lead_status_filter"
                        ...
                        <div id="div_lead_sub_status_filter" class="col-sm-2" style="display:none;">
                            <div class="form-group">
                                ...
                                <select multiple class="form-control form-control-sm select_list_filter"
                                    id="lead_sub_status_filter" name="lead_sub_status[]">
            ...
            <div class="card-footer mt-n3">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="text" id="btnFiterSubmitSearch" class="btn bg-lightblue rounded-right"><i
                            class="fad fa-binoculars"></i> Filtrar</button>
                    <button type="text" id="btnFiterRefresh"
                        class="btn ml-1 mr-1 rounded-left rounded-right bg-lightblue"><i class="fad fa-sync"></i>
                        Refrescar Info</button>
                    <button type="text" id="btnCleanLeadID" class="btn bg-lightblue rounded-left"><i
                            class="fad fa-eraser"></i> Limpiar Filtros</button>
                </div>
                @if (isset($_GET['lead_id_request']))
                    <a href="{{ url('leadcrud') }}" target="_self" type="text" class="btn bg-lightblue"><i
                            class="fad fa-redo"></i> Ver Todos los Leads</a>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="card card-lightblue card-outline">
        <div class="card-header pl-3 pr-3 pt-2 pb-0">
            <h4><i class="fad fa-id-card fa-lg text-lightblue"></i> {!! $pageTitle !!} <i style="font-size:50%;"
                    class="fas fa-lg fa-angle-double-down text-bold text-lightblue"></i></h4>
        </div>
        <div class="card-body">
            <div class="row" style="margin: auto;">
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table
                            ...
                            <thead>
                                <tr>
                                    <th class="text-center">&nbsp;&nbsp;<input name="select_all" value="1"
                                            type="checkbox"></th>
