<div class="modal modal-wide fade" id="leadStoryModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered mw-100 w-75" role="document">
        <div class="modal-content">   
            ...
            <div class="modal-body">
                <form id="leadFormStory" name="leadFormStory" class="form-horizontal" enctype="multipart/form-data">   
                    <input type="hidden" name="lead_id_notes_story" id="lead_id_notes_story">
                    <input type="hidden" name="id_note_story" id="id_note_story">
                    <div class="card-deck">
                                ...
                                <div class="row mt-1" style="margin: auto;">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <select style="width:100%;" class="form-control form-control-sm select_list" id="lead_notes_via_story" name="lead_notes_via_story" maxlength="250">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            ...
                                            <textarea  id="lead_notes_story_observation" name = "lead_notes_story_observation" class="form-control" style="height:auto;" rows="5" maxlength="2000" placeholder="Ingrese una observación."></textarea> 
                                        </div>
                                    </div>
                                    {{-- <div class="col-sm-3">
                                        <div class="form-group">
                        ...
                        <div class="card card-lightblue card-outline col-sm-4">
                            <div class="card-body p-1">
                                <div id="leadInfoStory"></div>
                            </div>
                        </div>
                    </div> 
                    <div class="float-right">
                        <button type="submit" class="btn bg-lightblue" id="saveBtnLeadNotesStory" value="lead-notes">Crear Nota</button>
                    </div>
