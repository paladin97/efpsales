<script>
    ...
    $("#contract_payment_type_id").change(function () {
        ...
        switch($(this).val()) {
            case '1':
                ...
                $("#monthly_payment").addClass('d-none');
                if($("#enroll").val() == "1"){
                    $("#enroll_single_payment").html('<b>MATRÍCULA: </b> + 300€')
                }
                else{
                    $("#enroll_single_payment").html('')
                }
                break;
            case '2':
                $("#single_payment").addClass('d-none');
    ...
    $("#contract_method_type_id").change(function () {
        ...
        var fee_value_financial = $("#pp_fee_value").val();
        if (method == 5){
            console.log(fee_value_financial);
            switch (service_group) {
                case "1":
                    fee_value_financial = parseFloat(fee_value_financial) + 24;
                    break;
                case "2":
                    fee_value_financial = parseFloat(fee_value_financial) + 21;
                    break;
                case "3":
                    fee_value_financial = parseFloat(fee_value_financial) + 18;
                    break;
                case "4":
                    fee_value_financial = parseFloat(fee_value_financial) + 18;
                    break;
                ...
                case "6":
                    ...
                    break;
                case "7":
                    fee_value_financial = parseFloat(fee_value_financial) + 30;
                    break;
                case "8":
                    fee_value_financial = parseFloat(fee_value_financial) + 30;
                    break;
        ...
        $("#pp_fee_value").val(fee_value_financial);        
    });
