					...
					<div class="row">
						<div class="col-sm-3">
						  <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
							...
							<a class="nav-link" id="vert-tabs-payment_method-tab" data-toggle="pill" href="#vert-tabs-payment_method" role="tab" aria-controls="vert-tabs-payment_method" aria-selected="false"><span class="fa-stack"><span class="fad fa-circle text-lightblue fa-stack-2x"></span><strong class="fa-stack-1x text-white">4</strong></span> Medios de pago</a>
							<a class="nav-link" id="vert-tabs-payment_type-tab" data-toggle="pill" href="#vert-tabs-payment_type" role="tab" aria-controls="vert-tabs-payment_type" aria-selected="false"><span class="fa-stack"><span class="fad fa-circle text-lightblue fa-stack-2x"></span><strong class="fa-stack-1x text-white">5</strong></span> Forma de pago</a>
						  ...
						  <div class="tab-content" id="vert-tabs-tabContent">
							<div class="tab-pane text-left fade active show" id="vert-tabs-personal" role="tabpanel" aria-labelledby="vert-tabs-personal-tab">
								...
								<div class="row mt-n2">
									...
									<div class="col-sm-2">
										<div class="form-group">
											<label for="name" class="mb-n1">Móvil <span style="font-size:8px!important"> indicativo (+34)</span>  <label class="text-red">(*)</label></label>
							...
							<div class="tab-pane fade" id="vert-tabs-case" role="tabpanel" aria-labelledby="vert-tabs-case-tab">
								<div class="row mt-n2">
									...
									<div class="col-sm-3">
										<div class="form-group">
											<label for="name" class="mb-n1">Descuento<label class="text-red">&nbsp;</label></label>
											<input type="text" class="form-control form-control-sm" id="discount_value" name="discount_value" placeholder='Introduce el descuento'  pattern='[0-9]{1,}'>
										</div>
									</div>
								</div>
								<div class="row mt-n2">
									<div class="col-sm-3">
										<div class="form-group">
											<label for="name" class="mb-n1">Abona derechos de matrícula <label class="text-red">(*)</label></label>
									...
									<div class="col-sm-9" id="postpone_enroll_div">
										<div class="row">
											<div class="col-sm-3">
												<div class="form-group">
													<label for="name" class="mb-n1">Importe Cuota 1 <label class="text-red">&nbsp;</label></label>
													<input type="text" class="form-control form-control-sm" id="enroll_postpone_start" name="enroll_postpone_start" placeholder='Introduce el importe'  pattern='[0-9]{1,}'>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													<label for="name" class="mb-n1">Fecha Cuota 1 <label class="text-red">&nbsp;</label></label>
													<input type="date" class="form-control form-control-sm" id="postpone_enroll_start" name="postpone_enroll_start">
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													<label for="name" class="mb-n1">Importe Cuota 2 <label class="text-red">&nbsp;</label></label>
													<input type="text" class="form-control form-control-sm" id="enroll_postpone_end" name="enroll_postpone_end" placeholder='Introduce el importe'  pattern='[0-9]{1,}'>
												</div>
											</div>
											<div class="col-sm-3">
												<div class="form-group">
													<label for="name" class="mb-n1">Fecha Cuota 2 <label class="text-red">&nbsp;</label></label>
													<input type="date" class="form-control form-control-sm" id="postpone_enroll_end" name="postpone_enroll_end">
												</div>
											</div>
										</div>
										<p class="text-lightblue"><i class="fad fa-info-circle text-lightblue"></i><b> Cuando hay derechos de matrícula:</b></p>
										<ul style="font-size:12px;">
											<li><I>Si la matrícula abona los derechos de matrícula en la fecha de pago solo debe rellenar el campo de <b>"Importe Cuota 1"</b>.</I></li>
											<li><I>Si la matrícula abona los derechos de matrícula en una fecha diferente a la fecha de aceptación de contrato debe rellenar el campo de <b>"Importe Cuota 1"</b> y el campo de <b>"Fecha Cuota 1"</b>.</I></li>
											<li><I>Si la matrícula abona los derechos de matrícula en dos cuotas debe rellenar todos los campos de las cuotas.</I></li>
										</ul>
									</div>
							...
							<div class="tab-pane fade" id="vert-tabs-payment_type" role="tabpanel" aria-labelledby="vert-tabs-payment_type-tab">
								<div class="row  mt-n2">
									<div class="col-sm-12">
										<h6 class="text-sm font-italic text-lightblue">Medio de Pago Seleccionado: <span id="paymentMethodInfo"></span></h6>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="row d-none mt-1" id="postponed_payment">
											<div class="col-sm-12">
												<div class="row">
													<div class="col-sm-4">
														<div class="form-group">
															<label for="name" class="mb-n1">Anticipo <label class="text-red">&nbsp;</label></label>
															<input type="text" class="form-control form-control-sm" id="pp_initial_payment" name="pp_initial_payment" placeholder='Introduce el importe'  pattern='[0-9]{1,}'>
														</div>
													</div>
													<div class="col-sm-4">
														<div class="form-group">
									...
									<div class="col-sm-12">
										<div class="form-group">
											...
											<select style="width:100%;"  class="form-control form-control-sm select_list" id="contract_method_type_id" name="contract_method_type_id">
												<option value="">Seleccione</option>
												@foreach(App\Models\ContractPaymentMethod::whereNotIn('id',[1,2])->orderBy('name','ASC')->get() as $cData)
												<option value="{{$cData->id}}">{{$cData->name}}</option>
												@endforeach
											</select>
										</div>
