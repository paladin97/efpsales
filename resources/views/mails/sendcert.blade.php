            	...
            	<tr>
            		<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
            			<div class="text" style="color:#0c0c0c!important;text-align: justify;">
            				<p> Estimado/ a  {{$data['client_full_name']}},</p>
                            <p>En atención a su solicitud, hacemos entrega del certificado del curso</p>
                            <p><b>{{$data['course_name']}}</b> en formato pdf</p>
            	...
            	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
				          	...
				          	<h3 class="name">Grupo EFP</h3>
				          	<span class="position">Construimos tu futuro</span>
			           	</div>
			          </td>
			        </tr>
            </table>
