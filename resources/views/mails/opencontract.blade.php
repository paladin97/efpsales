            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: center;">
            			<div class="text">
            				<h3 style="margin-bottom:0px">El contrato {{$data['enrollment_number']}}, ha sido recibido y leido </h3>
            			</div>
            		</td>
            	</tr>
            	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
				          	...
				          	<span class="position"><b>Fecha apertura: </b>{{$data['dt_apertura']}}<br></span>
				          	<span class="position"><b>Abierto y leído por: </b>{{$data['abierto_por']}}</span>
