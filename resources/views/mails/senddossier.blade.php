            	...
            	<tr>
            		<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
            			<div class="text" style="color:#0c0c0c!important;text-align: justify;">
            				<p> Estimado/ a  {{$data['client_full_name']}},
                            </p>
                            <p>Gracias por solicitar información sobre <b>{{$data['course_name']}}</b>. 
                                
                                Adjunto a este mensaje encontrarás el Dossier correspondiente.
                            </p>
                            <p>

                                Te agradecemos la confianza que has mostrado en nosotros.
                            </p>
                            <p>
                                Un cordial saludo,
