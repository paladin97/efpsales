            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
            	<tr>
            		<td style="padding: 0 2.5em; text-align: center;">
            			<div class="text">
            				<h3 style="margin-bottom:0px">El contrato {{$data['enrollment_number']}}, ha sido aceptado </h3>
            			</div>
            		</td>
            	</tr>
            	<tr>
			          <td style="text-align: center;">
			          	<div class="text-author">
				          	...
				          	<h3 class="name"><b>INFORMACIÓN DE REGISTRO</b></h3>
				          	<span class="position"><b>Fecha aceptación: </b>{{$data['dt_accept']}}<br></span>
				          	<span class="position"><b>Aceptado por: </b>{{$data['aceptado_por']}}<br></span>
				          	<span class="position"><b>Dirección IP del cliente: </b>{{$data['ip_aceptado']}}<br></span>
				          	<span class="position"><b>Estado Contrato: </b>{{$data['estado_contrato']}}</span>
				           	<p><a href="{{$data['url_contract']}}" class="btn " style="background-color:#3c8dbc!important;color:white;border-radius: 10px;">Ver Contrato</a></p>
			           	</div>
			          </td>
			        </tr>
            </table>
