    ...
    <div class="col-12 col-sm-4">
      <div class="bg-white p-2 elevation-3">
        <div class="p-1" align="center" style="background-color: #f6a137cf">
          <i class="fad fa-user-friends fa-3x text-white mobile-hide" style="margin-left: -120px;position: absolute;"></i>
    ...
    <div class="col-12 col-sm-4">
      <div class="bg-white p-2 elevation-3">
        <div class="p-1" align="center" style="background-color:  #a973e7cf">
          <i class="fad fa-euro-sign fa-3x text-white mobile-hide" style="margin-left: -120px;position: absolute;"></i>
    ...
    <div class="col-12 col-sm-4">
      <div class="bg-white p-2 elevation-3">
        <div class="p-1" align="center" style="background-color:  #077e2278">
          <i class="fad fa-chart-line fa-3x text-white mobile-hide" style="margin-left: -120px;position: absolute;"></i>
...
<div class="row animate__animated animate__backInRight mt-2 text-sm justify-content-md-center  @php if (Auth::user()->hasRole('teacher')) echo 'd-none' @endphp">
  <div class="col-12 col-sm-3">
    <div class="bg-white p-2 elevation-2">
      <div class="p-1" align="center" style="background-color: #e09a435e">
        <i class="fad fa-user-friends fa-2x text-gray mobile-hide" style="margin-left: -66px;position: absolute;margin-top: 5px;"></i>
  ...
  <div class="col-12 col-sm-3">
    <div class="bg-white p-2 elevation-2">
      <div class="p-1" align="center" style="background-color: #a973e76b">
        <i class="fad fa-euro-sign fa-2x text-gray mobile-hide" style="margin-left: -40px;position: absolute;margin-top: 5px;"></i>
  ...
  <div class="col-12 col-sm-3">
    <div class="bg-white p-2 elevation-2">
      <div class="p-1" align="center" style="background-color:  #077e2233">
        <i class="fad fa-chart-line fa-2x text-gray mobile-hide" style="margin-left: -30px;position: absolute;margin-top: 5px;"></i>
...
<div class="card-deck animate__animated animate__fadeIn @php if (Auth::user()->hasRole('teacher')) echo 'd-none' @endphp">
  ...
  <div class="card col-sm-6 elevation-3 p-2">
    <div class="card-body ">
      <h4 align="center"><i class="fad fa-map-marked text-bold text-lightblue text-lg"></i> Matrículas por Provincia</h4>
      <div id="spainMap" style="width:100%;height:300px"></div>
      <div>
        @foreach ($autonomousCommunityAll as $item)
          <span class="text-xs"><span class="badge bg-primary text-white" style="background-color: {{$item->color}}!important">&nbsp;{{$item->total}}&nbsp;</span> {{$item->name}}</span>
        @endforeach
      </div>     
    </div>
  </div>
...
<div class="row @php if (Auth::user()->hasRole('teacher')) echo 'd-none' @endphp">
    <div class="col-sm-6">
      <div class="card card-body elevation-3">
        <h4><i class="fad fa-chart-line text-bold text-lightblue text-lg"></i> Ingresos Por Asesor (€)<a class="text-xs float-right mt-3 " href="{{url('contractcrud')}}"><i class="fad text-lightblue fa-sign-out-alt"></i>&nbsp;Administrar&nbsp; </a></h4>
        <canvas id="canvasY" style="display: block; height: 533px; width: 1067px;" width="1173" height="586" class="chartjs-render-monitor"></canvas>
      </div>
      </div>
    <div class="col-sm-6">
      <div class="card card-body elevation-3">
        <h4><i class="fad fa-chart-line text-bold text-lightblue text-lg"></i> Matrículas  <a class="text-xs float-right mt-3 " href="{{url('contractcrud')}}"><i class="fad text-lightblue fa-sign-out-alt"></i>&nbsp;Administrar&nbsp; </a></h4>
        <canvas id="canvas" style="display: block; height: 533px; width: 1067px;" width="1173" height="586" class="chartjs-render-monitor"></canvas>
      </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-sm-6">
      <div class="card card-body elevation-3">
        ...
        <img class="calendarshow" style="cursor:pointer" src="{{asset('storage/uploads/Calendar.png')}}" width="100%" alt="">
      </div>
    </div>
    {{-- <div class="col-sm-6">
      <div class="card card-body elevation-3">
