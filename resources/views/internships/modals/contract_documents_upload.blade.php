    ...
    <div class="modal-dialog modal-dialog-centered mw-100 w-50" role="document">
        <div class="modal-content">   
            <div class="modal-header bg-lightblue color-palette">  
                <h4 class="modal-title" id="modelDocumentHeadingCase">Documentación de la Matrícula</h4>   
			...
			<span class="col-sm-12 text-xs mt-3">
                ...
                <ul class="text-red">
                    <li>Solo se permiten archivos en formato PDF o Imagen</li>
                    <li>Solo se puede subir un máximo de 10 archivos</li>
                    <li>Tamaño máximo permitido por archivo, 1MB</li>
