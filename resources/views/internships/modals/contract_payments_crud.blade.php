        ...
        <div class="modal-content">   
            ...
            <div class="modal-body">
                ...
                <div class="row"  style="margin:auto;">
                    <div class="col-sm-12">
                        <table id="datatable" class="small-table table-responsive table-sm stripe row-border order-column compact table table-striped" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th>Cuota</th>
                                    <th>Valor</th>
                                    ...
                                    <div class="row" id="fee_paid_row" style="display: none">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <textarea type="file"  class="form-control  form-control-sm" id="fee_observations" name="fee_observations" placeholder="Ingrese una observación." value="" maxlength="250"></textarea>
                                            </div>
                                        </div>
                                    </div>
