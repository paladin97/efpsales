        ...
        <div class="modal-content">     
            ...
            <div class="modal-body">    
                <form id="statusForm" name="statusForm" class="form-horizontal" enctype="multipart/form-data">   
                    <input type="hidden" name="contractsatus_id" id="contractsatus_id">
                    <div class="row mt-n2">
                        <div class="col-sm-2">
                            <label for="name" class="mb-n1">Tipo Contrato<label>&nbsp;</label></label>
                            <select style="width:100%;"  class="form-control form-control-sm select_list" id="contract_type" name="contract_type" maxlength="250">
                                <option value="">Seleccione</option>
                                @foreach (App\Models\ContractType::all()->sortBy('first_name') as $cData)
                        ...
                        <div class="col-sm-2">
                            <label for="name" class="mb-n1">N. Corto<label>&nbsp;</label></label>
                            <input type="text" class="form-control form-control-sm" id="short_name" name="short_name" placeholder="Ingrese una descripción" value="" maxlength="250">
                        </div>
                        <div class="col-sm-4">
