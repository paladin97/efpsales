...
@stop
@section('content')
@include('admin.course.modals.course_crud')
                ...
                <div class="row" style="margin: auto;">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm select_list_filter" id="course_company_filter" name="course_company_filter[]" multiple>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="name" class="mb-n1">Tipo</label>
                            <select class="form-control form-control-sm select_list_filter" id="course_type_filter" name="course_type_filter[]" multiple>
                                @foreach(App\Models\CourseType::all() as $cData)
                                    <option value="{{$cData->id}}">{{$cData->name}}</option>
                                @endforeach
                            </select>
                        </div>
...
{{-- <div class="row"> --}}
    <div class="card-deck">
        <div class="card card-lightblue card-outline col-sm-3">
            <div class="card-header pl-3 pr-3 pt-2 pb-0">
                <h4><i class="fad fa-chart-pie-alt text-bold text-lightblue text-lg"></i> Total Cursos por Grupo</h4>
            </div>
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
        ...
        <div class="card card-lightblue card-outline col-sm-9">
            <div class="card-header pl-3 pr-3 pt-2 pb-0">
                <h4><i class="nav-icon fad fa-chalkboard-teacher text-lightblue"></i> Listado de Ofertas Formativas</h4>
            </div>
            <div class="card-body">
...
@include('admin.course.js.jsfunctions')
{{-- Fin carga --}}
@endpush